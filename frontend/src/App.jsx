...
export function App() {
  ...
  const [state, setState] = useState({ products: [], categories: [], orders: [], customers: [], calendar: [], report: null, dashboard: null });
  ...
  async function loadPrivateData() {
    ...
    setError('');
    try {
      const [dashboard, orders, customers, calendar, report] = await Promise.all([
      ...
      setState(current => ({ ...current, dashboard, orders, customers, calendar, report }));
    } catch (err) {
  ...
  return (
    <main className="appShell">
      ...
      <section className="content">
        ...
        {active === 'reportes' && <Reports report={state.report} />}
